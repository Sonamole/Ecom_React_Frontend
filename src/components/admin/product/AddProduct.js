    ...
    formData.append('status',product.status);
      ...
      axios.post('api/store-product', formData, {
        ...
        if(response.data.status===200)
        {
            ...
            swal("All fields are mandatory",response.data.message,"error")
                    ...
                    <div className="tab-content" id="pills-tabContent">
                        ...
                        <div className="tab-pane card-body border fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                            ...
                            <div className="col-md-4 form-group mb-3">
                                ...
                                <input type="checkbox"  onChange={handleInput} value={product.featured}  name='featured' className='w-50 h-50' />
                            </div>
                            <div className="col-md-4 form-group mb-3">
                                <label>Popular (Checked-shown)</label>
                                <input type="checkbox"  onChange={handleInput} value={product.popular} name='popular'className='w-50 h-50' />
                            </div>
                            <div className="col-md-4 form-group mb-3">
                                <label>Status (Checked-hidden)</label>
                                <input type="checkbox"  onChange={handleInput} value={product.status} name='status' className='w-50 h-50' />
                            </div>
                            </div>
                        </div>
                    </div>
